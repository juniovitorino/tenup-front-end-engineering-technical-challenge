...
const StyledTopNavigationMenu = styled.div<TopNavigationMenuProps>`
  ...
  padding: 2rem 2.6rem;
  width: 130px;
  background-color: ${(p: TopNavigationMenuProps) =>
    p.isOpen ? "var(--menu-footer-background-color)" : "transparent"};
      ...
      <StyledToggleButton
        ...
        {isMenuVisible && (
          <svg
            ...
            <path
              fill="#fff"
              d="m35.767 10.176 4.739 4.74-25.59 25.59-4.74-4.739z"
            />
            <path
              fill="#fff"
              d="m41.129 35.644-4.74 4.739L10.8 14.792l4.739-4.74z"
            />
          </svg>
        )}
      </StyledToggleButton>
